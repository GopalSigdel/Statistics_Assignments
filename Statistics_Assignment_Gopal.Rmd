...
qqline(model1_error, col = "green",lwd=1)
...
C_I1=-2.996730
C_I2=3.017749
p2 <- plot(density(Y_training_data), col="black", lwd=2,
main="Distribution of Training Data")
abline(v=C_I1,col="green", lty=2)
abline(v=C_I2,col="green", lty=2)
